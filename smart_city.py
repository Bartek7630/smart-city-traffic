...
if start_button:
    if "youtube.com" not in youtube_url and "youtu.be" not in youtube_url:
        st.error("Wklej poprawny link do YouTube")
    else:
        with st.spinner("Łączenie z serwerami YouTube..."):
            try:
                ...
                if not streams:
                    ...
                    stream_reader = LiveStream(best_stream.url)
                    ...
                    while stream_reader.cap.isOpened() and not stop_button:
                        ...
                        # ==========================================
                        # Aktualizujemy przeglądarkę tylko, jeśli minął odpowiedni ułamek sekundy (15 FPS)
